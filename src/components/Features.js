      ...
      <div className="max-w-full mx-auto items-center px-4">
        <div className="grid grid-cols-1 md-auto">
          ...
          <div className="grid grid-cols-3 justify-between">
            ...
            <div className="grid grid-cols-1 items-center" id="features2">
              <div className="flex items-center justify-center py-2">
          ...
          <div className="grid grid-cols-2 px-4 py-6 gap-8 items-center mt-16 ">
            <div className="grid grid-cols-1 py-4 text-5xl font-bold text-brand-gray" id="features4">
            ...
            <div className="grid grid-cols-1 w-3xl h-full bg-brand-ltgreen px-2 py-4 items-center justify-center content-center align-center" id="features5">
              ...
              <div className="flex py-6 px-6 gap-4 justify-between">
                <div className="flex py-4 text-brand-blue font-bold text-3xl">96%</div>
          ...
          <div className="grid grid-cols-2 mt-14" id="features6">
            <div className="flex flex-1 w-3xl h-full bg-brand-ltgreen px-6 py-4 items-center justify-center content-center align-center">
              <div className="grid grid-cols-1 py-4 px-4 gap-4 justify-between">
                ...
                <div className="grid grid-cols-2 w-full px-4 py-6" id="features7">
                  <div className="flex w-4xl">
                    <div className="grid gap-4 w-2xl" dir="rtl">
                      <p className="flex py-6 px-4 text-5xl font-bold text-brand-gray">Expand your learning</p>
                      <p className="flex py-6 px-4 text-5xl font-bold text-brand-gray">Accomplish your goals</p>
                      <p className="flex py-6 px-4 text-5xl font-bold text-brand-gray" >Strengthen your vitality</p>
                      <p className="flex py-6 px-4 text-5xl font-bold text-brand-gray">Become a better caregiver</p>
                      <p className="flex py-6 px-4 text-5xl font-bold text-brand-gray">Improve your mood</p>
                      <p className="flex py-6 px-4 text-5xl font-bold text-brand-gray">Maximize your abilities</p>
                </div>
                </div>
            </div>
          </div>
